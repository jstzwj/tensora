...
namespace tensora
{
    ...
    {
    private:
        std::shared_ptr<TensorStorage<T>> rep;
    ...
    public:
        ...
        explicit Tensor(const DimVector& dimensions, const StrideVector& strides)
            :rep(new TensorStorage<T>),
        ...
        explicit Tensor(const DimVector& dimensions, const StrideVector& strides, layout_type order)
            :rep(new TensorStorage<T>),
